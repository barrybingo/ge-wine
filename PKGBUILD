...
pkgver=3.11.r0.gda5cec25+wine.3.11.r0.g58c49279f5
pkgrel=1
...
prepare() {
    ...
    git checkout tags/v3.11     # version checkout
    
    cd "${srcdir}"/gallium9
    git reset --hard HEAD      # restore tracked files
    git clean -xdf             # delete untracked files
    git checkout tags/wine-d3d9-3.11     # version checkout

    cd "${srcdir}"/wine-pba
    git reset --hard HEAD      # restore tracked files
    git clean -xdf             # delete untracked files
    git checkout tags/knobs_and_switches-v3.11     # version checkout
